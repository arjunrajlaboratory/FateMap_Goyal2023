#####################NOTE#####################
#Cleaned up version of V1: /Users/yogesh/Dropbox (RajLab)/FateMap/data/10X/10X/2020_FM02/jointAnalysis/seurat/hg19/s1s2_Scanoramahg19.R
##############################################
...
sample2100nMPlx.data <- Read10X(data.dir = "/Users/yogesh/Dropbox (RajLab)/FateMap/paper/rawData/10X_cellRangerOuts/FM02/2-100nMPLX/filtered_feature_bc_matrix/")

sample11uMPlx <- CreateSeuratObject(counts = sample11uMPlx.data, project = "Sample1_1uMPLX", min.cells = 3, min.features = 200)
sample2100nMPlx <- CreateSeuratObject(counts = sample2100nMPlx.data, project = "Sample2_100nMPLX", min.cells = 3, min.features = 200)
...
sample2100nMPlx <- subset(x = sample2100nMPlx, subset = nFeature_RNA > 200 & nFeature_RNA < 7200 & percent.mt < 30)
...
samples = c("Sample1_1uMPLX","Sample2_100nMPLX")
...
saveRDS(s1s2_scTransform, file = paste0(dataDirectory,'s1s2Scanorama_50pcs_filter_hg19.rds'))
...
umapClusters = (s1s2Scanorama[['scanorama_snn_res.0.8']])
