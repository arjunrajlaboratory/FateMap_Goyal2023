...
sample11umPlx.data <- Read10X(data.dir = "~/Dropbox (RajLab)/FateMap/REVISIONS/FateMapAnalysis_Jonas/2022_FM10/Cellranger/s3/filtered_feature_bc_matrix")
sample21umPlx.data <- Read10X(data.dir = "~/Dropbox (RajLab)/FateMap/REVISIONS/FateMapAnalysis_Jonas/2022_FM10/Cellranger/s4/filtered_feature_bc_matrix")
...
sample21umPlx <- subset(x = sample21umPlx, subset = nFeature_RNA > 200 & nFeature_RNA < 5800 & percent.mt < 20)
